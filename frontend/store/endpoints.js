...
export const GOOGLE_LOGIN_ENDPOINT = '/google-login'
...
export const SIGNUP_UPLOAD_URL_ENDPOINT = '/signup/upload-url'
export const IS_EMAIL_EXIST_ENDPOINT = '/isEmailExist'
export const REQUEST_SIGNUP_EMAIL_OTP_ENDPOINT = '/requestSignupEmailOtp'
export const VERIFY_SIGNUP_EMAIL_OTP_ENDPOINT = '/verifySignupEmailOtp'
export const REQUEST_PROFILE_EMAIL_CHANGE_ENDPOINT = '/profile/email/requestChange'
export const CONFIRM_PROFILE_EMAIL_CHANGE_ENDPOINT = '/profile/email/confirmChange'
export const CREATE_EMAIL_CORRECTION_REQUEST_ENDPOINT = '/cases/email-correction-request'
export const ADMIN_EMAIL_CORRECTION_REQUESTS_ENDPOINT = '/admin/emailCorrectionRequests'
export const LOGOUT_ENDPOINT = '/logout'
export const GET_USER_DATA_ENDPOINT = '/getUserData'
export const MARK_CASE_RESOLVED = '/markCaseResolved'
export const SUBMIT_SIGNATURE = '/submitSignature'
export const GET_SIGNATURE_REQUEST_DETAILS = '/getSignatureRequestDetails'
...
export const GET_ADMIN_WEBSITE_CONTENT_ENDPOINT = '/admin/website-content'
...
export const GET_INVOICE_PDF_ENDPOINT = '/invoices'
...
export const SUBMIT_AGREEMENT_SIGNATURE = '/submitAgreementSignature'
export const GET_DASHBOARD_CONTENT_ENDPOINT = '/getDashboardContent'
export const DELETE_NOTE_ENDPOINT = '/deleteNote'
export const GET_CASE_NOTE_ENDPOINT = '/getCaseNote'
export const GET_AGREEMENT_DETAILS_FOR_SIGNATURE = '/getAgreementDetailsForSignature'
...
export const ADMIN_UPDATE_USER_PROFILE_ENDPOINT = '/admin/updateUserProfile'
export const GET_MY_REWARDS_ENDPOINT = '/mediator/rewards'
export const REDEEM_REWARD_ENDPOINT = '/mediator/redeem-reward'
export const MEDIATOR_LEGAL_FEEDS_CATALOG_ENDPOINT = '/mediator/legal-feeds/catalog'
...
export const MEDIATOR_SUBSCRIPTION_PURCHASE_ENDPOINT = '/mediator/subscription/purchase'
export const MEDIATOR_PRIVATE_INVOICE_SETTINGS = '/mediator/private-invoice-settings'
export const MEDIATOR_PRIVATE_INVOICE_UPLOAD = '/mediator/private-invoice-settings/upload'
export const MEDIATOR_PRIVATE_INVOICES = '/mediator/private-invoices'
export const MEDIATOR_INCOME_ENDPOINT = '/mediator/income'
export const ADMIN_MEDIATOR_OFFBOARDING_PREVIEW = '/admin/mediators'
export const ADMIN_PREMIUM_FEATURES = '/admin/premium-features'
export const ADMIN_REWARD_FULFILLMENT_RULES = '/admin/reward-fulfillment-rules'
export const ADMIN_REWARD_FULFILLMENT_CATALOG = '/admin/reward-fulfillment-catalog'
export const ADMIN_NOTIFICATION_TEMPLATES = '/admin/notifications/templates'
export const ADMIN_NOTIFICATION_CHANNEL_SETTINGS = '/admin/notifications/channel-settings'
export const ADMIN_NOTIFICATION_USERS = '/admin/notifications/users'
...
export const ADMIN_NOTIFICATION_PREVIEW_LAYOUT = '/admin/notifications/preview-email-layout'

export const PUSH_VAPID_PUBLIC_KEY_ENDPOINT = '/push/vapid-public-key'
export const PUSH_REGISTER_ENDPOINT = '/push/register'
export const PUSH_UNREGISTER_ENDPOINT = '/push/unregister'
export const PUSH_PREFERENCES_ENDPOINT = '/push/preferences'
...
export const ADMIN_COUPONS_ENDPOINT = '/admin/coupons'
export const PUBLIC_COUPON_LOOKUP_ENDPOINT = '/public/coupon-lookup'
...
export const GET_BLOG_ASSETS = '/getBlogAssets'
...
export const ACCEPT_MEDIATION_REQUEST = '/acceptMediationRequest'
export const INITIATE_NEW_CASE_ENDPOINT = '/initiateNewCase'
export const APPROVE_CASE_TYPE_ENDPOINT = '/cases/approve-type'
export const ADD_CASE_REPRESENTATIVE_ENDPOINT = '/cases/add-representative'
export const GOOGLE_AUTH_ENDPOINT = '/authenticateWithGoogle'
export const GOOGLE_TOKEN_ENDPOINT = '/getGoogleToken'
...
export const GET_ADMIN_CASE_CORRESPONDENCE_ENDPOINT = '/admin/case-correspondence'
export const GET_ADMIN_CORRESPONDENCE_INBOX_ENDPOINT = '/admin/correspondence/inbox'
export const POST_ADMIN_CORRESPONDENCE_INBOX_MARK_READ_ENDPOINT = '/admin/correspondence/inbox/mark-read'
export const GET_ADMIN_CORRESPONDENCE_CONTEXT_ENDPOINT = '/admin/correspondence/context'
export const GET_ADMIN_CORRESPONDENCE_CASES_ENDPOINT = '/admin/correspondence/cases'
export const GET_ADMIN_WEBSITE_CONTACT_INBOX_ENDPOINT = '/admin/website-contact/inbox'
export const POST_PUBLIC_WEBSITE_CONTACT_LEAD_ENDPOINT = '/public/website-contact-lead'
